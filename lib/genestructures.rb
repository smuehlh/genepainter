...
def generate_gene_structures( list_of_genes_to_process, path_to_species_to_fasta, path_to_fasta, output_path)
	...
	path_to_genepainter = "/fab8/server/db_scripts/gene_painter_new/gene_painter" # FIXME adjust path to genepainter standalone, best create a constant with switch for fab8/cymo server
